...
* 优秀营员就是offer，保研填了直接过。在下机试中上，但是面试崩了，第一次参加夏令营果断凉了。
...
还没开始，但也很期待，因为我的一位老师说华师大的数据学院很好，因此拒了与他冲突的中科大（被中科大志愿着直接拉黑了，很莫名）。

### 一。机试
* 难度和复旦的机试差不多，但是题目量大了很多。
* 一共十道题
* 考了DP（难度比较大的DP），环，dfs，模拟，高精度，进制转换，简单图论，字符串处理。
* 做不来可以暴力吧，测试数据很弱。

### 二。面试
* 面试会让先抽一张纸，纸上有一段英语，会让你读两句，然后翻译。（我很悲剧地抽到了“信息检索”方面的论文，直接崩盘看不懂）
* 2分钟自我介绍
* 根据自我介绍进行提问（我没有这个环节，很奇怪），参加过数学竞赛的同学问了高数，建模的问建模，就没人问算法。
* 我和钱院长在那里讨论学制问题。

### 三。总结和碎碎念
* 由于人少，和老师以及高年级的学长学姐交流很多，这个团队以前是复旦大学很有名的一个团队。
...
* 这次发的优秀营员比较多，31发20个。
* 离我家比较近，三号线直达。
* 总体夏令营体验很好，就是硬件条件似乎是三个学校里面最不好的。（这我不得不说，我校机房水准是复旦级别的。）

## 综合对比

别问我为什么没去交大，这学校就是那么封闭！！！！！
下面某些东西是我主观感觉，不得不说同济电信学院办的真的一般！！！

### 学术氛围
* 复旦 > 华师大（指的数据学院，后面省略）> 同济（电信学院的计算机，由于我至今还是不知道同济老师们都干啥的）

### 夏令营体验
* 华师大 > 复旦 > 同济 

### 拿优秀营员难度
* 复旦 > 同济 > 华师大 （复旦真的是80里挑一了，九推吧！！！）

### 自由度
* 复旦 > 华师大 > 同济  （深切体会到了复旦的“自由而无用”，全程都很自由，你想干啥干啥。）
